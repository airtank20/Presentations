...
az vm create --resource-group CLIVMDemo --name CLIDemoVM --image MicrosoftSQLServer:SQL2019-WS2016:SQLDEV:latest --admin-username localadmin --admin-password Passw0rd12345 --size Standard_A5 --storage-sku Standard_LRS
